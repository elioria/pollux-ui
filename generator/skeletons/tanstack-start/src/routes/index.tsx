...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      {
        name: 'description',
        content: 'Painel administrativo do Pollux (skeleton TanStack Start).',
      },
    ],
  }),
  component: Home,
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Visão geral do painel administrativo. Este é um esqueleto TanStack
          Start (React + Vite) pronto para receber o código gerado por entidade.
        </p>
      </div>
